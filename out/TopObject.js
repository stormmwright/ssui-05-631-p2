...
export class TopObject extends DrawnObjectBase {
    ...
    damageArea(xv, yv, wv, hv) {
        ...
        //     this._damageRectW = Math.max(this._damageRectX + this._damageRectW, xv + wv) - this._damageRectX;
        //     this._damageRectH = Math.max(this._damageRectY + this._damageRectH, yv + hv) - this._damageRectY;
        // }
        if (!this._damaged) {
            this._damageRectX = xv;
            this._damageRectY = yv;
