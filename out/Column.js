...
export class Column extends Group {
    ...
    _doLocalSizing() {
        //=== YOUR CODE HERE ===
        let sum = { min: 0, nat: 0, max: 0 }, max = { min: 0, nat: 0, max: 0 };
        for (let child of this._children) {
            sum = SizeConfig.add(sum, child.hConfig);
            max = SizeConfig.maximum(max, child.wConfig);
        }
        this.hConfig = sum;
        this.wConfig = max;
    }
    ...
    availCompr) {
        ...
        for (let child of this.children) {
            //=== YOUR CODE HERE ===
            let childCompr = (child.h - child.minH) / availCompr;
            child.h = child.h - (childCompr / shortfall);
        }
    }
    //. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
