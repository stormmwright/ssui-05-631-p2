...
export class IconObject extends DrawnObjectBase {
    ...
    _resize() {
        var _a;
        //=== YOUR CODE HERE ===
        if (this.resizesImage || !((_a = this._image) === null || _a === void 0 ? void 0 : _a.canvasImage))
            return;
    ...
    _drawSelfOnly(ctx) {
        ...
        if (this.resizesImage) {
            ...
            //=== YOUR CODE HERE ===
            ctx.drawImage(this.image.canvasImage, 0, 0, this.image.canvasImage.naturalWidth, this.image.canvasImage.naturalHeight);
        }
    }
